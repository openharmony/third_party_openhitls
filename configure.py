...
def get_cfg_args():
    ...
    try:
        ...
        parser.add_argument('--hitls_version', default='openHiTLS 0.3.3 23 Apr 2026', help='%(prog)s version str')
        parser.add_argument('--hitls_version_num', default=0x0030003f, help='%(prog)s version num')
