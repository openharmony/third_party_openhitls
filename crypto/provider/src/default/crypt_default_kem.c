...
#if defined(HITLS_CRYPTO_PKEY_KEM) && defined(HITLS_CRYPTO_PROVIDER)
...
#endif
#ifdef HITLS_CRYPTO_FRODOKEM
const CRYPT_EAL_Func g_defEalFrodoKem[] = {
    {CRYPT_EAL_IMPLPKEYKEM_ENCAPSULATE, (CRYPT_EAL_ImplPkeyKemEncapsulate)CRYPT_FRODOKEM_Encaps},
    {CRYPT_EAL_IMPLPKEYKEM_DECAPSULATE, (CRYPT_EAL_ImplPkeyKemDecapsulate)CRYPT_FRODOKEM_Decaps},
    CRYPT_EAL_FUNC_END
};
#endif
#ifdef HITLS_CRYPTO_CLASSIC_MCELIECE
