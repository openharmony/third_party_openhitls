...
def get_cfg_args():
    ...
    try:
        ...
        parser.add_argument('--hitls_version', default='openHiTLS 0.3.0 12 Feb 2026', help='%(prog)s version str')
        parser.add_argument('--hitls_version_num', default=0x0030000f, help='%(prog)s version num')
